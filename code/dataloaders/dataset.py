...
class LAHeart_no_read(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None,with_idx=False):
        ...
        for i in range(len(self.image_list)):
            # aa = h5py.File(self._base_dir + "/2018LA_Seg_Training Set/" + self.image_list[i] + "/mri_norm2.h5", 'r')
            self.image_list_data.append(h5py.File(self._base_dir + "/2018LA_Seg_Training Set/" + self.image_list[i] + "/mri_norm2.h5", 'r'))
            # demo = self.image_list_data[0]['image'][:]
            # print('fsd')
    def __len__(self):
        return len(self.image_list)
